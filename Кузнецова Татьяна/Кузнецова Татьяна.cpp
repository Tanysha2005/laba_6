...
int main() {
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //материал
        glUniform3f(glGetUniformLocation(shader.ID, "material.ambient"), 0.0f, 0.7f, 0.6f); 
        glUniform3f(glGetUniformLocation(shader.ID, "material.diffuse"), 0.0f, 0.7f, 0.6f); 
